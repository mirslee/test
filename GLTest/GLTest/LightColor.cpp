...
void LightColor::ProcessMouseMovement(float xoffset, float yoffset)
{
	camera.ProcessMouseMovement(xoffset, yoffset);
}
void LightColor::ProcessMouseScroll(float yoffset)
{
	camera.ProcessMouseScroll(yoffset);
}
void LightColor::ProcessKeyboard(Camera_Movement key, float deltaTime)
{
